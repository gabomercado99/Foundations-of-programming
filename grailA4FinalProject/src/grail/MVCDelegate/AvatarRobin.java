...
public class AvatarRobin implements PaintListener {
	...
	public AvatarRobin() {
		Avatars robin = bridgeScene.getRobin();
		Avatars.addPropertyChangeListener(robin, this);
		
	}
	@Override
	public void paint(Graphics2D g) {
		imagePainter(g, bridgeScene.getRobin());
		linePainter(g, bridgeScene.getRobin().getTorso());
		limbsPainter(g, bridgeScene.getRobin().getArms(), bridgeScene.getRobin().getLegs());
		stringPainter(g, bridgeScene.getRobin().getStringShape());
