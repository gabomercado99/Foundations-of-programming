...
public class AvatarLancelot implements PaintListener{
	...
	public AvatarLancelot() {
		Avatars lancelot = bridgeScene.getLancelot();
		Avatars.addPropertyChangeListener(lancelot, this);
		
	}
	@Override
	public void paint(Graphics2D g) {
		imagePainter(g, bridgeScene.getLancelot());
		linePainter(g, bridgeScene.getLancelot().getTorso());
		limbsPainter(g, bridgeScene.getLancelot().getArms(), bridgeScene.getLancelot().getLegs());
		stringPainter(g, bridgeScene.getLancelot().getStringShape());
